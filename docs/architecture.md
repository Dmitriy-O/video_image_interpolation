...
**Примітка щодо величини ефекту:** чисельний виграш ΔPSNR сильно залежить від контенту відео. На відео з чіткими фазами руху (спокій → вибух, старт/зупинка, прискорення) адаптивні політики можуть давати помітний позитивний ефект на «важких» кластерах. На більшості «звичайних» відео (рівномірний рух) лінійна інтерполяція залишається близькою до оптимальної за PSNR — дельти modest або близькі до нуля. Головна педагогічна цінність — це інтерпретований pipeline (кластеризація за простими ознаками → призначення зрозумілих політик → строга temporal оцінка), а не гарантія великих чисел.
